...
def download_video():
    ...
    if youtube_url.startswith('https://www.youtube.com/'):
        ...
        user_update = Label(bottom, font=('arial', 20, 'bold'),
                            text=info, bd=5, anchor='w', bg=color)
...
bottom_lable = Label(bottom, font=('arial', 20, 'bold'),
                     text="YouTube Videos Downloader", bd=5, anchor='w', bg=color)
...
# ==================================================Radiobutton============
btn1_data = Radiobutton(left, text="Good Quality",  font=(
    'arial', 20, 'bold'), variable=quality,  value=0, bg=color)
btn1_data.grid(row=0,  column=1, sticky=W)
btn2_data = Radiobutton(left, text="Bad Quality",  font=(
    'arial', 20, 'bold'), variable=quality, value=1, bg=color)
